...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoicm9iZXJ0c3RpcHAiLCJhIjoiY2wyZGp3Y2VrMHo2aDNicGF4dmZ3MnMwMSJ9.kPqkdBEVeH-RdvRtEGvjyQ';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/robertstipp/cl2dk03lp00di14ln75d6g35v',
    // style URL
...
var stripe = Stripe('pk_test_51Ku21gKmuuTC3yER1COCTCtUljRrPlQoZWlq1rIos06NY34YR5wY2QT3x0L8bjQ3dQCkTeFRabxNmKsTruhpirXn00MRevlXPY');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            document.querySelector('.btn--save-password').textContentd = 'Save Password';
